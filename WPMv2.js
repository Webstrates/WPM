...
((window) => {
        ...
        static async findCompletePackageTreeSorted(packages = [], defaultOptions, overrideOptions = {}) {
            ...
            async function addRepo(repoUrl, options) {
                ...
                try {
                    ...
                    console.error("WPMv2 very important error: Could not resolve repository. This will probably cause the site to fail horribly! ", repoUrl);
                }
            }
    ...
    window.WPMv2 = {
        ...
        version: 2.24,
        revision: "$Id: WPMv2.js 883 2022-04-22 13:34:24Z au182865@uni.au.dk $"
    };
