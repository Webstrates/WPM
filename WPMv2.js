...
((window) => {
    ...
    class WPMv2 {
        static async bootstrap(packageDom, options, requireToken, triggerOnPackageInstalled = false) {
            ...
            wpmInterface.require = async (packages, extraOptions) => {
                ...
                if (packages != null) {
                    ...
                    for (let options of packages) {
                        if (typeof options === "string") {
                            ...
                            convertedPackages.push(options);
                        }
                    }
                } else {
        ...
        static async findCompletePackageTreeSorted(packages = [], defaultOptions, overrideOptions = {}) {
            ...
            async function addRepo(repoUrl) {
            ...
            for(let pkg of packages) {
                ...
                if (pkg instanceof WPMPackage) {
                    ...
                    wpmPackage = pkg;
                    if(overrideOptions.repository != null) {
                        wpmPackage.repository = overrideOptions.repository;
                    }
                    ...
                    if(pkg.startsWith("http") || pkg.startsWith("/")) {
                        ...
                        let options = Object.assign({}, defaultOptions, {"package": pkg}, overrideOptions);
        ...
        static async findAllDependencies(pkg) {
            ...
            for(let dependencyEntry of pkg.dependencyMap) {
                let dependency = await WPMv2.getLatestPackageFromPackage(new WPMPackage(dependencyEntry[0], dependencyEntry[1]));
    ...
    class WPMPackage {
        ...
        constructor(name, repository, descriptorJson = {}) {
            ...
            this.dependencies = [];
            /**
             * Optional Package dependencies (Not used right now)
             * @type {string[]}
             */
    ...
    window.WPMv2 = {
        ...
        version: 2.22,
        revision: "$Id: WPMv2.js 794 2021-10-20 10:09:56Z au182865@uni.au.dk $"
    };
