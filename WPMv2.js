...
((window) => {
    ...
    class WPMv2 {
        ...
        static lookupRepoAlias(alias) {
            ...
            let localStorageAliases = JSON.parse(localStorage.getItem(WPM_ALIASES));
            let sessionStorageAliases = JSON.parse(sessionStorage.getItem(WPM_ALIASES));
        ...
        static registerRepository(alias, repository, useLocalStorage = false) {
            ...
            if (typeof currentAliases !== "object"){
                currentAliases = {};
            }
    ...
    window.WPMv2 = {
        ...
        version: 2.26,
        revision: "$Id: WPMv2.js 895 2022-04-26 11:01:41Z au182865@uni.au.dk $"
    };
